...
if ( defined( 'PREDIC_WIDGET_VERSION' ) ) {
    ...
    trigger_error( esc_html__( 'Framework Predic_Widget already exists. Please check if those are the same framework versions for campatibility.', 'inx-game' ), E_USER_WARNING );
