...
class Predic_Widget_Fa_Iconpicker_Field extends Predic_Widget_Form_Field {
    ...
    public function field() {
        ...
        $html .= '<section class="predic-widget-fa-iconpicker predic-widget-fa-iconpicker__field">';
		     ...
		     * Search field
		     */
		    $html .= '<input type="text" class="widefat predic-widget-fa-iconpicker__search" placeholder="' . esc_html__( 'Search icons', 'inx-game' ) . '"/>';
		     ...
		     * Clear button
		     */
	        $html .= '<button type="button" class="button predic-widget-fa-iconpicker__clear">' . esc_html__( 'Clear', 'inx-game' ) . '</button>';

		    /**
		     * Default value
		     */
	        if ( !empty( $this->default ) ) {
	            $html .= '<button type="button" class="button predic-widget-fa-iconpicker__default" data-default="' . esc_attr( $this->default ) . '">' . esc_html__( 'Default', 'inx-game' ) . '</button>';
	        }
