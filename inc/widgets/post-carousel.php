...
class Inx_Game_Post_Carousel{
    ...
    public function render_view( $args, $instance, $form_fields, $widget_id ) {
        ...
        $columns_md			 = isset( $instance['columns_md'] ) ? $instance['columns_md'] : '3';
        $columns_sm			 = isset( $instance['columns_sm'] ) ? $instance['columns_sm'] : '2';
        $columns_xs			 = isset( $instance['columns_xs'] ) ? $instance['columns_xs'] : '1';
		...
		if( !empty( $recent_posts ) ){
			echo '<div class="inx-post-carousel-widgets" data-md="'.esc_attr(  $columns_md ).'" data-sm="'.esc_attr( $columns_sm ).'" data-xs="'.esc_attr( $columns_xs ).'">';
			foreach($recent_posts as $post) : ?>
                <div class="inx-widgets-carousel-item">
    ...
    public function map_and_init() {
        ...
        $config = array(
             ...
             * @var string (required)
             */
            'base_id' => 'inx_post_carousel',
			
			/**
             * Widget name
             * @var string (required)
             */
            'name' => esc_html__('+ INX Posts Carousel', 'inx-game'),
             ...
             */
            'widget_ops' => array(
                'classname' => 'inx-post-carousel',
                'description' => esc_html__( 'Recent Posts Posts Carousel. ', 'inx-game' ),
            ...
            'form_fields' => array(
				...
				'columns_md' => array(
					'type' => 'select', // Required
					'label' => esc_attr__( 'Columns( desktops ):', 'inx-game' ), // Optional
					'options' => array(
						'1' =>esc_attr__( 'Columns 1', 'inx-game' ), 
						'2' =>esc_attr__( 'Columns 2', 'inx-game' ), 
						'3' =>esc_attr__( 'Columns 3', 'inx-game' ), 
						'4' =>esc_attr__( 'Columns 4', 'inx-game' )
					)
					
				),
				'columns_sm' => array(
					'type' => 'select', // Required
					'label' => esc_attr__( 'Columns( tablets  ):', 'inx-game' ), // Optional
					'options' => array(
						'1' =>esc_attr__( 'Columns 1', 'inx-game' ), 
						'2' =>esc_attr__( 'Columns 2', 'inx-game' ), 
						'3' =>esc_attr__( 'Columns 3', 'inx-game' ), 
				...
				'columns_xs' => array(
					'type' => 'select', // Required
					'label' => esc_attr__( 'Columns( phones   ):', 'inx-game' ), // Optional
					'options' => array(
						'1' =>esc_attr__( 'Columns 1', 'inx-game' ), 
						'2' =>esc_attr__( 'Columns 2', 'inx-game' ), 
						'3' =>esc_attr__( 'Columns 3', 'inx-game' ), 
